...
public class Save_MIURA : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // StageManagerに保存しておいたデータを送る
        StageManagerScript = GameObject.Find("StageManager").GetComponent<StageManagerScript>();
        StageManagerScript.SetStageInformation(StageClearDate);
    ...
    public void OnApplicationQuit()
    {
        // ステージのクリア状況を書き込む
        // ステージのクリア状況をもらってくる
        StageClearDate = StageManagerScript.GetStageInformation();
